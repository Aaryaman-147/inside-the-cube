          ...
          <section>
            ...
            <article>
              <ul>
                ...
                <li><a href="http://localhost:3000/" target="_blank" rel="noopener noreferrer">Open-Source Cortex</a><span className="status-indicator status-dev" title="In Development"></span> — idk</li>
